...
class CButtonColumn extends CGridColumn
{
	 ...
	 */
	public $htmlOptions=array('class'=>'button-column', 'style' => 'white-space:nowrap;');
	/**
	...
	public $viewButtonOptions=array('class'=>'cspace2 glyphicon glyphicon-zoom-in');
	...
	public $updateButtonOptions=array('class'=>'cspace2 glyphicon glyphicon-edit');
	...
	public $deleteButtonOptions=array('class'=>'cspace2 glyphicon glyphicon-remove');
	...
	protected function initDefaultButtons() {
		...
		if($this->viewButtonImageUrl === null) {
			...
			$this->viewButtonImageUrl = '';
		}
			
		if($this->updateButtonImageUrl===null) {
			// $this->updateButtonImageUrl=$this->grid->baseScriptUrl.'/update.png';
			$this->updateButtonImageUrl = '';
		}
			
		if($this->deleteButtonImageUrl===null) {
			// $this->deleteButtonImageUrl=$this->grid->baseScriptUrl.'/delete.png';
			$this->deleteButtonImageUrl = '';
		}
